...
def _start_webhooks():
    """Connect the event bus to the durable webhook dispatcher when configured."""
    try:
        from .. import events
        ...
        logger.warning("Webhook dispatcher not started: %s", exc)


def _ensure_queue_worker():
    """Compatibility seam for tests and deployments that supervise startup."""
